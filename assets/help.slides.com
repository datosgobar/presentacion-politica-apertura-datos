...
<meta name="csrf-token" content="n48C1napEJErPWL5lUW8IN2PPnhS8zdEZXq03KU1QotfHHEfeexYYmYGiMntL5zdWjI9GGAEPGFEZhWH+KTvzQ==" />
  ...
  <link rel="stylesheet" media="all" href="//assets1.uvcdn.com/pkg/clients/site2-33402f6e282db869caef6967c967ef4a.css" />
  ...
  <!--[if lt IE 9]>
    <script src="//assets0.uvcdn.com/pkg/clients/site2/lt_IE_9-2c58c1ee1dbefb700ef2333ae314783d.js"></script>
  <![endif]-->
    ...
    <a href="/forums/175819-general/suggestions/3563810-change-transition-effect-per-slide">6 comments</a>
                ...
                <section class="uvModuleSection uvModuleSection-recentlyUpdatedIdeas">
                  ...
                  <ul class="uvList uvList-recentlyUpdatedIdeas">
                      ...
                      <li class="uvListItem uvListItem-idea-18131284 uvIdea uvIdea-small">
                        <h4 class="uvListItemHeader"><a href="/forums/175819-general/suggestions/18131284-ai-error-messages-and-ai-help-that-is-context-sens">Ai error messages and ai help that is context sensitive.</a></h4>
                        <p class="uvStyle-meta">
                          
                            <a href="/forums/175819-general/status/792684" title="View other declined ideas like Ai error messages and ai help that is context sensitive."><em class="uvStyle-status uvStyle-status-declined">declined</em></a>
...
<fieldset class="uvSignin uvSignin-prestine uvSignin-default uvFieldset" data-options="{&quot;subclass&quot;:&quot;StandaloneSignin&quot;}"  aria-live="polite" aria-relevant="additions removals" data-subclass='StandaloneSignin'>
  ...
  <div class="uvSigninMode" style="display:none">prestine</div>
      <div class="uvField uvField-display_name uvField-first">
        <label class="uvFieldInner" for="display_name_4174">
          <span class="uvFieldPlaceholder">Your name</span>
          <input class="uvFieldText" type="text" name="display_name" id="display_name_4174" title="Your name" />
        </label>
      </div>
      <div class="uvField uvField-email uvField-first">
        <label class="uvFieldInner" for="email_4174">
          <span class="uvFieldPlaceholder">Your email address</span>
          <input class="uvFieldText" type="email" name="email" id="email_4174" value="" title="Your email address">
        </label>
        ...
        <div class="uvFieldEtc uvFieldEtc-providers">
            ...
            <ul>
                            <li data-provider="facebook"><a href="https://graph.facebook.com/oauth/authorize?client_id=46468144668&amp;redirect_uri=https%3A%2F%2Fauth.uservoice.com%2Ffacebook%2F147810&amp;scope=email&amp;display=popup" tabindex="0" title="Sign in via Facebook"><img class="favicon" src="//assets1.uvcdn.com/pkg/shared/favicons/facebook-8b92ce8bf5e8258f342c1990afd055fc.png" alt="facebook" /></a></li>
      ...
      <div class="uvField uvField-authentication">
        ...
        <div class="password">
          <label class="uvFieldInner" for="password_4174">
            <span class="uvFieldPlaceholder">UserVoice password</span>
            <input class="uvFieldPassword" type="password" name="password" id="password_4174" title="UserVoice password" />
          </label>
...
<!-- site2 index cached -->
  ...
  <script src="//assets0.uvcdn.com/pkg/clients/site2-edc22d1b7f22fb1345e4a8858686908a.js"></script>
  <script type="text/javascript">
